...
def get_sales_data():
    ...
    Run a while loop to collect a valid string of data from the user via the terminal, while must be a string of 6 numbers separated by commas. The loop will repeatedly request data, until ot is valid.
    """
